module StatisticsHelper
  def statistics_subtitle(filters, paragraphs)
    filter = filters[0]
    ...
    return I18n.t('statistics.index.subtitle', filter: translation) if paragraphs.blank?

    I18n.t('statistics.index.subtitle_with_paragraphs', filter: translation)
  end
end
