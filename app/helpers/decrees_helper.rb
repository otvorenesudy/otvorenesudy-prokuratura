module DecreesHelper
  def decrees_download_icon_link(url, options = {})
    n, c, t = %w[arrow-right text-primary decrees.download]
    ...
    link_to content_tag(:span, 'data-toggle' => :tooltip, title: I18n.t(t, i18n_options)) { icon_tag(n, size: options.delete(:size)) } , url, target: '_blank'
  end
end