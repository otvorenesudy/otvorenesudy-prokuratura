class CrimesController < ApplicationController
  def index
    ...
    @count = Rails.cache.fetch('crimes_count', expires_in: 1.day) { Crime.count }
  end
  ...
  def index_params
    params.permit(:comparison, :paragraph_suggest, :show_default_paragraphs, year: [], metric: [], paragraph: [])
  end
