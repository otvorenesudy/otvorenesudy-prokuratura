module GenproGovSk
  class ImportDeclarationsJob < ApplicationJob
    ...
    OFFICES_MAP = {
      ...
      'KPBB' => 'Krajská prokuratúra Banská Bystrica',
      ...
      'KPTT' => 'Krajská prokuratúra Trnava',
      ...
      'KPNR' => 'Krajská prokuratúra Nitra',
