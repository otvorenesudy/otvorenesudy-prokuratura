...
ActiveRecord::Schema.define(version: 2023_12_12_171612) do
  ...
  create_table 'crimes', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[year metric paragraph], name: 'index_crimes_on_year_and_metric_and_paragraph', unique: true
  end
  ...
  create_table 'employees', force: :cascade do |t|
    ...
    t.index %w[office_id disabled_at rank],
            name: 'index_employees_on_office_id_and_disabled_at_and_rank',
            unique: true,
  ...
  create_table 'genpro_gov_sk_declarations', force: :cascade do |t|
    t.jsonb 'data', null: false
    t.binary 'file', null: false
    t.string 'digest', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['digest'], name: 'index_genpro_gov_sk_declarations_on_digest', unique: true
  end
  ...
  create_table 'statistics', force: :cascade do |t|
    ...
    t.index ['paragraph'], name: 'index_statistics_on_present_paragraph', where: '(paragraph IS NOT NULL)'
    t.index %w[year office_id metric paragraph],
            name: 'index_statistics_on_year_and_office_id_and_metric_and_paragraph',
            unique: true
