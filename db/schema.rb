...
ActiveRecord::Schema[7.1].define(version: 2023_12_12_171612) do
  ...
  create_table "crimes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["year", "metric", "paragraph"], name: "index_crimes_on_year_and_metric_and_paragraph", unique: true
  end
